...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../STI_dac_v1.2.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../STI_dac_v1.2.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../STI_dac_v1.2.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../STI_dac_v1.2.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../STI_dac_v1.2.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
       +incdir+"E:/ProgramFile/Xilinx/Vivado/2018.3/data/xilinx_vip/include"
}
